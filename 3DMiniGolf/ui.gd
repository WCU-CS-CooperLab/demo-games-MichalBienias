...
@onready var shots = $MarginContainer/VBoxContainer/Shot

var bar_textures = {
	"green": preload("res://assets 3/bar_green.png"),
	"yellow": preload("res://assets 3/bar_yellow.png"),
	"red": preload("res://assets 3/bar_red.png")
}
